...
class _TimelapseTabState extends State<TimelapseTab> {
  ...
  void getPreciosFranjas() {
    ...
    var startList = List<Duration>.generate(
      franjas,
      (int index) => Duration(minutes: index * (minutos == 0 ? 60 : minutos)),
    );
    ...
    // ORDENA LOS PRECIOS
    var sortedKeys = mapInicioPrecios.keys.toList(
      growable: false,
  ...
  void submitDuracion() async {
    ...
    if (mounted) {
      setState(() {
        ...
        franjas = getFranjas(duracion: duration.inMinutes, step: minutos);
      });
      getPreciosFranjas();
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      ButtonsUpDownTimer(upTimer: upMin, downTimer: downMin),
                    ],
                  ),
                  Row(
                    children: [
...
class ButtonsUpDownTimer extends StatelessWidget {
  ...
  const ButtonsUpDownTimer({
    super.key,
    required this.upTimer,
    required this.downTimer,
  });
          ...
          return Container(
            ...
            child: ListTile(
              ...
              titleTextStyle: Theme.of(
                context,
              ).textTheme.titleLarge!.copyWith(color: StyleApp.backgroundColor),
              subtitleTextStyle: Theme.of(
                context,
              ).textTheme.titleSmall!.copyWith(color: StyleApp.backgroundColor),
